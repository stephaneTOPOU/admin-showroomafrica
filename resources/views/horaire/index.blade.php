                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{route('horaire.create')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                                ...
                                                @foreach ($horaires as $horaire)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $horaire->identifiant }})" data-id="{{ $horaire->identifiant }}" data-target="#default{{ $horaire->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('horaire')}}/" + identifiant
