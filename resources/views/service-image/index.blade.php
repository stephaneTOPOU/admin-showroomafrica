                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{route('image.create')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                                ...
                                                @foreach ($images as $image)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $image->identifiant }})" data-id="{{ $image->identifiant }}" data-target="#default{{ $image->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
