                        ...
                        <div class="">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Enrégistrer un pays</h3>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label >Iso</label>
                                                    <input type="text" class="form-control" placeholder="Entrez l'iso du pays" name="iso" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label >Pays</label>
                                                    <input type="text" class="form-control" placeholder="Entrez le nom du pays" name="libelle" required>
                                                </div>
                                            </div>
                                        </div>
