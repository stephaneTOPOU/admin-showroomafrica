                                                ...
                                                @foreach ($sousCategories as $sousCategorie)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{-- <form method="POST" action="{{ route('sub-category.destroy',$sousCategorie->id) }}" class="btn-group">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $sousCategorie->identifiant }})" data-id="{{ $sousCategorie->identifiant }}" data-target="#default{{ $sousCategorie->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('sub-category')}}/" + identifiant
