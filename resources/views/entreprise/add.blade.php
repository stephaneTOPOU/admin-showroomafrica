                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote-1" name="descriptionCourte"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck2"
                                                name="honneur" value="1">
                                            <label class="form-check-label" for="exampleCheck2">sélection
                                                d'entrprise</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck5"
                                                name="pharmacie_de_garde" value="1">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck6"
                                                name="a_publireportage" value="1">
                                            <label class="form-check-label"
                                                for="exampleCheck6">apublireportage</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="exampleCheck7"
                                                name="a_magazine" value="1">
