                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <h3 class="card-title">Slider De Recherche</h3>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="{{route('sliderrecherche.create')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                            ...
                                            <tbody>
                                                @foreach ($sliders as $slider)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{route('sliderrecherche.edit',$slider->identifiant)}}" class="btn btn-default">
                                                                    <i class="fas fa-edit"></i> Modifier
                                                                </a>
                                                            </div>
                                                            {{-- <form method="POST" action="{{ route('sliderrecherche.destroy',$slider->identifiant) }}" class="btn-group">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('sliderrecherche')}}/" + identifiant
