                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" style="width: 100%;" name="entreprise_id">
                                                        ...
                                                        @foreach ($entreprises as $entreprise)
                                                            <option value="{{ $entreprise->id }}" {{ $partenaires->entreprise_id == $entreprise->id ? 'selected' : '' }}>{{ $entreprise->nom }} - {{ $entreprise->pays }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="exampleInputFile">{{old('image')??$partenaires->image}}</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
