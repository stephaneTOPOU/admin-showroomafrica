                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <h3 class="card-title">Les partenaires des entreprises</h3>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="{{route('partenaire.create')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                            ...
                                            <tbody>
                                                @foreach ($partenaires as $partenaire)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{route('partenaire.edit',$partenaire->identifiant)}}" class="btn btn-default">
                                                                    <i class="fas fa-edit"></i> Modifier
                                                                </a>
                                                            </div>
                                                            {{-- <form method="POST" action="{{ route('partenaire.destroy',$partenaire->identifiant) }}" class="btn-group">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $partenaire->identifiant }})" data-id="{{ $partenaire->identifiant }}" data-target="#default{{ $partenaire->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('gallerie')}}/" + identifiant
