                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <a href="{{route('gallerie.create')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                                ...
                                                @foreach ($galleries as $gallerie)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $gallerie->identifiant }})" data-id="{{ $gallerie->identifiant }}" data-target="#default{{ $gallerie->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
