                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h3 class="card-title">La gallerie image</h3>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="{{ route('gallerie.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($galleries as $gallerie)
                                            <tr>
                                                ...
                                                <td><img src="https://www.showroomafrica.com/assets/images/companies/showroom/gallery/{{ $gallerie->galerie_image }}"
                                                        width="60"></td>
                                                <td>{{ $gallerie->created_at }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('gallerie.edit', $gallerie->identifiant) }}"
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $gallerie->identifiant }})"
                                                        data-id="{{ $gallerie->identifiant }}"
                                                        data-target="#default{{ $gallerie->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
