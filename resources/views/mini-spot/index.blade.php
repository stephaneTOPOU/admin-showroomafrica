                                    ...
                                    <tbody>
                                        @foreach ($minspots as $minispot)
                                            <tr>
                                                ...
                                                <td><video
                                                        src="https://www.showroomafrica.com/assets/videos/{{ $minispot->video }}"
                                                        width="200" height="100" autoplay muted type="video/mp4">
                                                    </video></td>
                                                <td><img src="https://www.showroomafrica.com/assets/videos/posters/{{ $minispot->image }}"
                                                        width="60"></td>
                                                <td>{{ $minispot->libelle }}</td>
                                                <td>{{ $minispot->created_at }}</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('mini-spot.edit', $minispot->identifiant) }}"
                                                            class="btn btn-default">
                                                            <i class="fas fa-edit"></i> Modifier
                                                        </a>
                                                    </div>
                                                    {{-- <form method="POST" action="{{ route('minispot.destroy',$minispot->identifiant) }}" class="btn-group">
                                                                @csrf
                                                                @method('DELETE')
                                                    ...
                                                    <button class="btn btn-default"
                                                        onclick="deleteData({{ $minispot->identifiant }})"
                                                        data-id="{{ $minispot->identifiant }}"
                                                        data-target="#default{{ $minispot->identifiant }}">
                                                        <i class="fas fa-trash"></i> Supprimer
                                                    </button>
                                                        ...
                                                        function deleteData(identifiant) {
                                                            ...
                                                            Swal.fire({
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{ url('mini-spot') }}/" + identifiant
