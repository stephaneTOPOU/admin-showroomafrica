                        ...
                        <div class="">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Ajouter un mini - spot </h3>
                                </div>
                                @if(Session::has('success'))
                                    <div class="alert alert-success" role="alert">{{Session::get('success') }}</div>
                                @endif
                                <form role="form" method="POST" action="{{ route('mini-spot.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        ...
                                        <button type="submit" class="btn btn-primary">Ajoter</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
