                                            ...
                                            <tbody>
                                                @foreach ($slider2s as $slider2)
                                                    <tr>
                                                        ...
                                                        <td>{{ $slider2->admin }}</td>
                                                        <td><img src="https://www.showroomafrica.com/assets/images/sliders/main/{{$slider2->image}}" width="100"></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-default" onclick="deleteData({{ $slider2->identifiant }})" data-id="{{ $slider2->identifiant }}" data-target="#default{{ $slider2->identifiant }}">
                                                                <i class="fas fa-trash"></i> Supprimer
                                                            </button>
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('slider2')}}/" + identifiant
