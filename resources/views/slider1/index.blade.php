                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <h3 class="card-title">Slider Haut</h3>
                                            </div>
                                            <div class="col-md-2">
                                                <a href="{{route('slider1.add')}}" class="btn btn-block btn-success pull-right">  Ajouter  </a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.card-header -->
                                            ...
                                            <tbody>
                                                @foreach ($slider1s as $slider1)
                                                    <tr>
                                                        ...
                                                        <td>{{ $slider1->admin }}</td>
                                                        <td><img src="{{asset('assets/images')}}/{{$slider1->image}}" width="100"></td>
                                                        <td>{{ $slider1->created_at }}</td>
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{route('slider1.update')}}" class="btn btn-default">
