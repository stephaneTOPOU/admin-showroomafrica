                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-10">
                                        <h3 class="card-title">Reportages</h3>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="{{ route('reportage.create') }}"
                                    ...
                                    <tbody>
                                        @foreach ($reportages as $reportage)
                                            <tr>
                                                ...
                                                <td><iframe width="100%" height="100px" src="{{ $reportage->video }}"
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('reportage.edit', $reportage->identifiant) }}"
