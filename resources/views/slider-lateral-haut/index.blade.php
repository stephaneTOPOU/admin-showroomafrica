                                            ...
                                            <tbody>
                                                @foreach ($sliders as $slider)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                <a href="{{route('sliderhaut.edit',$slider->identifiant)}}" class="btn btn-default">
                                                                    <i class="fas fa-edit"></i> Modifier
                                                                </a>
                                                            </div>
                                                            {{-- <form method="POST" action="{{ route('sliderhaut.destroy',$slider->identifiant) }}" class="btn-group">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            function deleteData(identifiant) {
                                                                ...
                                                                if (result.isConfirmed) {
                                                                    ...
                                                                    let url = "{{url('sliderhaut')}}/" + identifiant
